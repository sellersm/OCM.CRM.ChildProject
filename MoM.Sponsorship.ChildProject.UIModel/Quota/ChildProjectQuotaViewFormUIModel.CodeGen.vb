...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'Child Project Quota View Form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.View, "da5dca4e-1878-49d5-932a-a09a878023ca", "c7c88c72-fb7a-4a90-92f5-e31da377bfb9", "Child Project Extension")> _
Partial Public Class [ChildProjectQuotaViewFormUIModel]
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.DataFormTemplateId = New Guid("da5dca4e-1878-49d5-932a-a09a878023ca")
        MyBase.DataFormInstanceId = New Guid("c7c88c72-fb7a-4a90-92f5-e31da377bfb9")
        MyBase.RecordType = "Child Project Extension"
        MyBase.FixedDialog = True
        MyBase.UserInterfaceUrl = "browser/htmlforms/custom/ChildProject.Quota.ViewForm.html"
