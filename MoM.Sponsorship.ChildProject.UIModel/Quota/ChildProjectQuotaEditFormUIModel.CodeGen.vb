...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'Child Project Quota Edit Form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.Edit, "2c2d9665-e758-40c5-88b9-252dc93413cc", "151e5109-8f2d-4ea6-984c-58eed60793eb", "Child Project Extension")> _
Partial Public Class [ChildProjectQuotaEditFormUIModel]
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.DataFormInstanceId = New Guid("151e5109-8f2d-4ea6-984c-58eed60793eb")
        MyBase.RecordType = "Child Project Extension"
        MyBase.FixedDialog = True
        MyBase.UserInterfaceUrl = "browser/htmlforms/custom/ChildProject.Quota.EditForm.html"
